...
public abstract class ScrollOptionPanelBehaviour<E extends Enum<E> & INamedIconOptions> extends ScrollPanelBehaviour {
    ...
    public ScrollOptionPanelBehaviour(String translationKey, PanelType<?> type, FactoryPanelBlockEntity be, FactoryPanelBlock.PanelSlot slot, Class<E> enum_) {
        super(Component.translatable(translationKey), type, be, slot);
