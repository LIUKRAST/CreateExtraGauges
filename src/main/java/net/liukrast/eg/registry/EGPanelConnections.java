...
public class EGPanelConnections {
    ...
    public static final DeferredHolder<PanelConnection<?>, PanelConnection<FilterItemStack>> FILTER = CONNECTIONS.register("filter", () -> new PanelConnection<>((from, to) -> 0, FilterItemStack.class));
